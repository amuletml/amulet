...
transformExpr fe = goE where
  ...
  transE (Match e bs p a) = Match (goE e) (map goArm bs) p a
  transE (Function bs p a) = Function (map goArm bs) p a
  ...
  transE (MLet v p e b a) = MLet v p (goE e) (goE b) a
...
transformExprTyped fe fc ft = goE where
  ...
  transE (Match e bs p a) = Match (goE e) (map goArm bs) p (goA a)
  transE (Function bs p a) = Function (map goArm bs) p (goA a)
  ...
  transE (MLet v p e b a) = MLet v (goP p) (goE e) (goE b) (goA a)
...
correct ty (Match e bs p a) = Match e bs p (fst a, ty)
correct ty (Function bs p a) = Function bs p (fst a, ty)
...
correct ty (MLet v p e b a) = MLet v p e b (fst a, ty)
