...
Top :: { Toplevel Parsed }
    ...
    | type ident ListE(TyVar) Ctors            { TypeDecl (getName $2) (map getL $3) Nothing $4 }
    | type ident ListE(TyVar) ':' Type Ctors   { TypeDecl (getName $2) (map getL $3) (Just (getL $5)) $6 }
