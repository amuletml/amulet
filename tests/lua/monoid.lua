do
  ...
  local function _dollartraverse(bhn, cgv, k, cu)
    ...
    elseif cu.__tag == "Cons" then
      local cgs = cu[1]
      return cgv["<*>"](cgv["Applicative$kl"](_colon_colon)(k(cgs._1)))(_dollartraverse(nil, cgv, k, cgs._2))
    end
  end
  local function _dollar_d7(blz, x, ys)
    ...
    elseif x.__tag == "Cons" then
      local chs = x[1]
      return Cons({ _1 = chs._1, _2 = _dollar_d7(nil, chs._2, ys) })
    end
  end
  local cix = { _1 = 1, _2 = nil }
